...
Ветки вида `feature/*-assign-to-changelog` не предлагаются как источник changelog. При отмене команды или ошибке CLI возвращается на выбранную ветку-источник.
